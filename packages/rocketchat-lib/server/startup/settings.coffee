...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		@add 'Layout_Home_Title', 'douChat', { type: 'string', public: true }
		@add 'Layout_Home_Body', '欢迎使用doChat！<br> 转到设置－布局来更改此页', { type: 'code', code: 'text/html', multiline: true, public: true }
		...
		@add 'Layout_Login_Terms', '使用本软件就代表你已经同意了<a href="/terms-of-service">服务条款</a>和<a href="/privacy-policy">用户协议</a>.', { type: 'string', multiline: true, public: true }
